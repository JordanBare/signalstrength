...
public class CellInfoDataImpl {
    ...
    private final TelephonyManager telephonyManager;
        ...
        private static final String CELL_INFO_KEY_IS_REGISTERED = "CELL_INFO_IS_REGISTERED";
    private static final String CELL_INFO_KEY_TIMESTAMP_VALUE = "CELL_INFO_TIMESTAMP_VALUE";
    private static final String CELL_INFO_KEY_CDMA_BSID = "CELL_INFO_CDMA_BSID";
    private static final String CELL_INFO_KEY_CDMA_BSLATITUTE= "CELL_INFO_CDMA_BSLATITUDE";
    private static final String CELL_INFO_KEY_CDMA_BSLONGITUDE = "CELL_INFO_BSLONGITUDE";
    private static final String CELL_INFO_KEY_CDMA_NETWORKID = "CELL_INFO_CDMA_NETWORKID";
    private static final String CELL_INFO_KEY_CDMA_SYSTEMID = "CELL_INFO_CDMA_SYSTEMID";
    private static final String CELL_INFO_KEY_CDMA_ASU_LEVEL = "CELL_INFO_CDMA_ASU_LEVEL";
    private static final String CELL_INFO_KEY_CDMA_RSSI_DBM = "CELL_INFO_CDMA_RSSI_DBM";
    private static final String CELL_INFO_KEY_CDMA_ECIO = "CELL_INFO_CDMA_ECIO";
    protected static final String CELL_INFO_KEY_CDMA_LEVEL = "CELL_INFO_CDMA_LEVEL";
    protected static final String CELL_INFO_KEY_CDMA_DBM = "CELL_INFO_CDMA_DBM";
    private static final String CELL_INFO_KEY_CDMA_EVDO_DBM = "CELL_INFO_CDMA_EVDO_DBM";
    private static final String CELL_INFO_KEY_CDMA_EVDO_ECIO = "CELL_INFO_CDMA_EVDO_ECIO";
    private static final String CELL_INFO_KEY_CDMA_EVDO_LEVEL = "CELL_INFO_CDMA_EVDO_LEVEL";
    private static final String CELL_INFO_KEY_CDMA_EVDO_SNR = "CELL_INFO_CDMA_EVDO_SNR";
    private static final String CELL_INFO_KEY_CDMA_LEVEL2 = "CELL_INFO_CDMA_LEVEL2";
    protected static final String CELL_INFO_VALUE_CDMA = "CELL_INFO_VALUE_CDMA";
    private static final String CELL_INFO_KEY_GSM_CID = "CELL_INFO_GMS_CID";
    private static final String CELL_INFO_KEY_GSM_LAC = "CELL_INFO_GSM_LAC";
    private static final String CELL_INFO_KEY_GSM_MCC = "CELL_INFO_GSM_MCC";
    private static final String CELL_INFO_KEY_GSM_MNC = "CELL_INFO_GSM_MNC";
    private static final String CELL_INFO_KEY_GSM_ASU_LEVEL = "CELL_INFO_GSM_ASU_LEVEL";
    protected static final String CELL_INFO_KEY_GSM_DBM = "CELL_INFO_GSM_DBM";
    protected static final String CELL_INFO_KEY_GSM_LEVEL = "CELL_INFO_GSM_LEVEL";
    protected static final String CELL_INFO_VALUE_GSM = "CELL_INFO_VALUE_GSM";
    private static final String CELL_INFO_KEY_LTE_CI = "CELL_INFO_LTE_CI";
    private static final String CELL_INFO_KEY_LTE_MCC = "CELL_INFO_LE_MCC";
    private static final String CELL_INFO_KEY_LTE_MNC = "CELL_INFO_LTE_MNC";
    private static final String CELL_INFO_KEY_LTE_PCI = "CELL_INFO_LTE_PCI";
    private static final String CELL_INFO_KEY_LTE_TAC = "CELL_INFO_LTE_TAC";
    private static final String CELL_INFO_KEY_LTE_ASU_LEVEL = "CELL_INFO_LTE_ASU_LEVEL";
    protected static final String CELL_INFO_KEY_LTE_DBM = "CELL_INFO_LTE_DBM";
    protected static final String CELL_INFO_KEY_LTE_LEVEL = "CELL_INFO_LTE_LEVEL";
    private static final String CELL_INFO_KEY_LTE_TIMING_ADVANCE = "CELL_INFO_LTE_TIMING_ADVANCE";
    protected static final String CELL_INFO_VALUE_LTE = "CELL_INFO_VALUE_LTE";
    private static final String CELL_INFO_KEY_WCDMA_CID = "CELL_INFO_WCDMA_CID";
    private static final String CELL_INFO_KEY_WCDMA_LAC = "CELL_INFO_WCDMA_LAC";
    private static final String CELL_INFO_KEY_WCDMA_MCC = "CELL_INFO_WCDMA_MCC";
    private static final String CELL_INFO_KEY_WCDMA_MNC = "CELL_INFO_WCDMA_MNC";
    private static final String CELL_INFO_KEY_WCDMA_PSC = "CELL_INFO_WCDMA_PSC";
    private static final String CELL_INFO_KEY_WCDMA_ASU_LEVEL = "CELL_INFO_WCDMA_ASI_LEVEL";
    protected static final String CELL_INFO_KEY_WCDMA_DBM = "CELL_INFO_WCDMA_DBM";
    protected static final String CELL_INFO_KEY_WCDMA_LEVEL = "CELL_INFO_WCDMA_LEVEL";
    protected static final String CELL_INFO_VALUE_WCDMA = "CELL_INFO_VALUE_WCDMA";
